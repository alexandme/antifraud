...
def gtan_main(feat_df, graph, train_idx, test_idx, labels, args, cat_features):
    ...
    for fold, (trn_idx, val_idx) in enumerate(
        ...
        model_filename = os.path.join(model_save_path, 'gtan_best_model.pth')

        earlystoper = early_stopper(patience=args["early_stopping"], verbose=True, save_path=model_filename)
